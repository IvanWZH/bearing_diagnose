...
feature_get(r'D:\py-program\phm_zhoucheng\train_set\B_train.csv',
            r'D:\py-program\phm_zhoucheng\featureset\B_feature.csv', 400, 1)
feature_get(r'D:\py-program\phm_zhoucheng\train_set\IR_train.csv',
            r'D:\py-program\phm_zhoucheng\featureset\IR_feature.csv', 400, 3)
feature_get(r'D:\py-program\phm_zhoucheng\train_set\NORMAL_train.csv',
            r'D:\py-program\phm_zhoucheng\featureset\NORMAL_feature.csv', 400, 0)
feature_get(r'D:\py-program\phm_zhoucheng\train_set\OR_train.csv',
            r'D:\py-program\phm_zhoucheng\featureset\OR_feature.csv', 400, 2)